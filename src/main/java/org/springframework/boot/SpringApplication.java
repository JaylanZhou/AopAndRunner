...
import org.springframework.beans.factory.support.MyLog;
...
public class SpringApplication {
    ...
    private void callRunners(ApplicationContext context, ApplicationArguments args) {
        ...
        for (Object runner : new LinkedHashSet<>(runners)) {
            Future<Object> subTask = TEST_POOL_EXECUTOR.submit(new Callable<Object>() {
                @Override
                public Object call() throws Exception {
                    long start = System.currentTimeMillis();
                    if (runner instanceof ApplicationRunner) {
                        MyLog.log("Runner:" + "App:" + runner);
                        callRunner((ApplicationRunner) runner, args);
                        MyLog.log("Runner:" + (System.currentTimeMillis() - start) + ":App:" + runner);
                    }
                    if (runner instanceof CommandLineRunner) {
                        MyLog.log("Runner:" + "Com:" + runner);
                        callRunner((CommandLineRunner) runner, args);
                        MyLog.log("Runner:" + (System.currentTimeMillis() - start) + ":Com:" + runner);
                    }
                    return null;
                }
            });
        ...
        MyLog.log("Runner all:" + (System.currentTimeMillis() - allStart));
    }
    ...
    private void callRunner(ApplicationRunner runner, ApplicationArguments args) {
        try {
            ...
            MyLog.log("ApplicationRunner Exception");
            MyLog.log(ex);
            System.out.println("ApplicationRunner Exception");
            System.out.println(new IllegalStateException("Failed to execute ApplicationRunner", ex));
    ...
    private void callRunner(CommandLineRunner runner, ApplicationArguments args) {
        try {
            ...
            MyLog.log("CommandLineRunner Exception");
            MyLog.log(ex);
            System.out.println("CommandLineRunner Exception");
            System.out.println(new IllegalStateException("Failed to execute CommandLineRunner", ex));
