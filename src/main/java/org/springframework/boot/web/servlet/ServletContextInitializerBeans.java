...
//
//import org.eclipse.aether.internal.impl.collect.MyMvnUtil;
//import org.springframework.aop.scope.ScopedProxyUtils;
//import org.springframework.beans.factory.ListableBeanFactory;
//import org.springframework.beans.factory.support.BeanDefinitionRegistry;import org.springframework.beans.factory.support.MyLog;
...
//        Map<String, T> map = new LinkedHashMap<>(); T bean2 = null;
//        for (String name : names) { long start = System.nanoTime();
//            if (!excludes.contains(name) && !ScopedProxyUtils.isScopedTarget(name)) {
//                T bean =bean2= beanFactory.getBean(name, type);
//                if (!excludes.contains(bean)) {
//                    map.put(name, bean);
//                }
//            }
//            MyLog.log("@===@:"+(System.nanoTime()-start)+":"+beanFactory.getBeanDefinitionNames().length+":"+name+":"+type+":"+(org.springframework.boot.web.servlet.FilterRegistrationBean.class.isAssignableFrom(bean2.getClass())?((org.springframework.boot.web.servlet.FilterRegistrationBean)bean2).getFilter()+"-AA":bean2.getClass()));
//        }
